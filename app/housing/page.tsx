...
export default function HousingPage() {
  ...
  return (
    <main className="housing-page">
      ...
      <footer><a className="brand portal-brand footer-brand" href={sitePath("/")}><span className="shift-mark" aria-hidden="true">N</span><span>NIIGATA LIFE ATLAS<small>新潟生活観測所</small></span></a><p>Make the trade-offs visible.</p><a href="#database">ページ上部へ ↑</a></footer>
